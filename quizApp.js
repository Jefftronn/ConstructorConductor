...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
  quizUsers.push(new User("Tyler", "tylermcginnis33@gmail.com", "iLoveJS"));
  quizUsers.push(new User("Cahlan", "cahlan@devmounta.in", "iLoveHashtags"));
  quizUsers.push(new User("Lenny", "lenny@theLenster.com", "iLoveLentilSoup"));
...
console.log('My users Array and my questions arrray are ' + verify(););
//Now loop console.log your users array and your questions array and verify that they're both holding the right data.

  //code here
var verify = function(quizUsers, questions) {
  for (var i = 0; i < QuizUser.length; i++) {
    console.log(quizUsers[i]);
    console.log(questions[i]);
  }
}

verify(quizUsers, questions);
